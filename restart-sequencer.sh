...
kurtosis service exec cdk cdk-erigon-sequencer-001 'cp \-r /etc/cdk-erigon/ /tmp/ && sed -i '\''s/zkevm\.use-tx-orderer: false/zkevm.use-tx-orderer: true/;'\'' /tmp/cdk-erigon/config.yaml'
