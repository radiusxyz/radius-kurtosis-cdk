...
kurtosis service exec cdk cdk-erigon-sequencer-001 'cp \-r /etc/cdk-erigon/ /tmp/ && sed -i '\''s/zkevm\.use-tx-orderer: true/zkevm.use-tx-orderer: false/;'\'' /tmp/cdk-erigon/config.yaml'
