...
DEFAULT_IMAGES = {
    ...
    "zkevm_contracts_image": "availproject/cdk-zkevm-contracts:avail-develop-v9.0.0-rc.5-pp-fork.12",  # Polygon zkevm-contracts with avail integration  https://github.com/availproject/cdk-zkevm-contracts/
